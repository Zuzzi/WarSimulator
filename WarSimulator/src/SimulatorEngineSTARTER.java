...
public class SimulatorEngineSTARTER {
	...
	public static void starter (Army a, Army b, Battlefield c) {
		...
		percentualeStrategiaA = SimulatorEngine.calcolaPercentualeStrategia(a.strategia, tipoTruppeA,
				                                                            b.strategia, tipoTruppeB);
		...
		if (Globali.matchStrategia) {
			...
			percentualeStrategiaB = SimulatorEngine.calcolaPercentualeStrategia(b.strategia, tipoTruppeB,
                    a.strategia, tipoTruppeA);
