	...
	void creaStrategia () {
		...
		Globali.battaglia.random();
		  ...
		  situazione.setText(" Il campo di battaglia è "+Globali.battaglia.terreno +" di " + Globali.battaglia.orario + "."
		  		...
		  		+ "\n è il popolo "+Globali.avversario.popolo +", formato da truppe " + Globali.avversario.truppe  
...
public class GUIstrategia extends JFrame {
	   ...
	   JRadioButton strategia1;
	   JRadioButton strategia2;
	   JRadioButton strategia3;
	...
	void creaStrategia () {
	      ...
	      strategia1 = new JRadioButton("mantenere la posizione",true);
	      strategia2 = new JRadioButton("accerchiamento",false);
	      strategia3 = new JRadioButton("attacco frontale",false);
	      
	      
	      Cstrategia = new JPanel();
	      group = new ButtonGroup();
	      avvia = new JButton("avvia simulazione");
	      ...
	      strategia1.setBounds(0,0,200,50);
	      strategia2.setBounds(0,50,200,50);
	      strategia3.setBounds(0,100,200,50);
	      avvia.setBounds(150,450,200,30);
