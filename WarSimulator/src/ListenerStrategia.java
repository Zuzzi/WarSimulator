...
public class ListenerStrategia implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (sorgente == GUIstrategia.avvia) {
			...
			for (int i = 0; !GUIstrategia.lista.get(i).isSelected(); i++)
				k++;
			...
			if (Globali.giocatore.popolo.equals("Roma"))
				ListenerTruppeRoma.strategia.setVisible(false);
			else if (Globali.giocatore.popolo.equals("Europa"))
				ListenerTruppeEuropa.strategia.setVisible(false);
			else if (Globali.giocatore.popolo.equals("Giappone"))
				ListenerTruppeGiappone.strategia.setVisible(false);
