...
public class ListenerSalvataggio implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (sorgente == GUIsalvataggio.ok) {
			...
			if (Globali.giocatore.generale.equals("Vlad l'Impalatore"))
				Globali.giocatore.generale = "Vlad l Impalatore";
			else if (Globali.giocatore.generale.equals("Giovanna d'Arco"))
				Globali.giocatore.generale = "Giovanna d Arco";
			else if (Globali.giocatore.generale.equals("Scipione l'Africano"))
				Globali.giocatore.generale = "Scipione l Africano";

			if (Globali.avversario.generale.equals("Vlad l'Impalatore"))
				Globali.avversario.generale = "Vlad l Impalatore";
			else if (Globali.avversario.generale.equals("Giovanna d'Arco"))
				Globali.avversario.generale = "Giovanna d Arco";
			else if (Globali.avversario.generale.equals("Scipione l'Africano"))
				Globali.avversario.generale = "Scipione l Africano";

			query = "insert into SALVATAGGIO values  " + "('" + GUIsalvataggio.nome.getText() + "'," + "'"
					+ Globali.battaglia.terreno + "'," + "'" + Globali.battaglia.orario + "'," + +Globali.vincitore
					+ "," + "'" + Globali.giocatore.popolo + "'," + "'" + Globali.giocatore.generale + "'," + "'"
					+ Globali.giocatore.truppe + "'," + "'" + Globali.giocatore.strategia + "'," + "'"
					+ Globali.avversario.popolo + "'," + "'" + Globali.avversario.generale + "'," + "'"
					+ Globali.avversario.truppe + "'," + "'" + Globali.avversario.strategia + "')";
